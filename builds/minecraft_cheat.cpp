...
int main() {
    wstring processName = L"javaw.exe";
    wstring moduleName = L"minecraft.jar";
    
    cout << "=== CheatForge: javaw.exe ===" << endl;
    ...
    cout << "[+] Features: killaura, reach, fly, speed, xray, esp, autotool" << endl;
