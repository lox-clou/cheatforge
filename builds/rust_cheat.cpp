...
// Игра: RustClient.exe
// Процесс: RustClient.exe
// Модуль: GameAssembly.dll
...
int main() {
    wstring processName = L"RustClient.exe";
    wstring moduleName = L"GameAssembly.dll";
    
    cout << "=== CheatForge: RustClient.exe ===" << endl;
    ...
    cout << "[+] Features: silent_aim, triggerbot, player_esp, ore_esp, fly, speed, autofarm" << endl;
