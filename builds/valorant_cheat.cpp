...
int main() {
    wstring processName = L"VALORANT.exe";
    wstring moduleName = L"VALORANT.exe";
    
    cout << "=== CheatForge: VALORANT.exe ===" << endl;
    ...
    cout << "[+] Features: aimbot, triggerbot, esp, glow, bhop, radar" << endl;
