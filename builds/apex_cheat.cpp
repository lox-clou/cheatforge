...
int main() {
    wstring processName = L"r5apex.exe";
    wstring moduleName = L"r5apex.exe";
    
    cout << "=== CheatForge: r5apex.exe ===" << endl;
    ...
    cout << "[+] Features: aim_assist, glow_esp, item_esp, tapstrafe, superglide" << endl;
